...
public class Personaje extends Actor
{
    ...
    public Personaje()
    {
        ...
        imagenes.add(new GreenfootImage("Arale1.png"));//4
        imagenes.add(new GreenfootImage("Arale2.png"));//4
        imagenes.add(new GreenfootImage("Arale3.png"));//4
        imagenes.add(new GreenfootImage("Arale4.png"));//4
        imagenes.add(new GreenfootImage("Milk1.png"));//4
        imagenes.add(new GreenfootImage("Milk2.png"));//4
        imagenes.add(new GreenfootImage("Milk3.png"));//4
        imagenes.add(new GreenfootImage("Milk4.png"));//4
    }
